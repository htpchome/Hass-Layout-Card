...
`,gt="1.0.4",$t="hass-layout-card",vt={type:`custom:${$t}`,title:"Layout Card",subtitle:"",show_datetime:!0,datetime_format:"default",content:"<p>Welcome to your custom layout card!</p>"},yt={default:{date:{weekday:"long",year:"numeric",month:"long",day:"numeric"},time:{hour:"2-digit",minute:"2-digit"}},short:{date:{year:"numeric",month:"short",day:"numeric"},time:{hour:"2-digit",minute:"2-digit"}},iso:{date:{year:"numeric",month:"2-digit",day:"2-digit"},time:{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}}};var At;let bt=class extends nt{static get styles(){return mt}setConfig(t){this._config={...vt,...t}}render(){if(!this._config)return q`<div class="editor-container">Loading...</div>`;const t=Object.keys(yt).map(t=>q`
    ...
    `}_handleTitleChange(t){const e=t.target;this._updateConfig({title:e.value})}_handleSubtitleChange(t){const e=t.target;this._updateConfig({subtitle:e.value})}_handleShowDatetimeChange(t){const e=t.target;this._updateConfig({show_datetime:e.checked})}_handleDatetimeFormatChange(t){const e=t.target;this._updateConfig({datetime_format:e.value})}_handleContentChange(t){const e=t.target;this._updateConfig({content:e.value})}_updateConfig(t){if(!this._config)return;const e={...this._config,...t};this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0}))}};t([dt({attribute:!1})],bt.prototype,"hass",void 0),t([ut()],bt.prototype,"_config",void 0),bt=t([ct("hass-layout-card-editor")],bt);let wt=class extends nt{constructor(){super(...arguments),this._currentDateTime=new Date,this._touchStartY=0,this._touchActive=!1,this._wasAtTop=!1}static get styles(){return mt}static getConfigElement(){return document.createElement("hass-layout-card-editor")}static getStubConfig(){return{...vt}}set hass(t){this._hass=t}get hass(){return this._hass}setConfig(t){if(!t)throw new Error("Invalid configuration");this._config={...vt,...t}}getCardSize(){return 3}connectedCallback(){super.connectedCallback(),this._startDateTimeUpdate(),this._setupScrollFix()}disconnectedCallback(){super.disconnectedCallback(),this._stopDateTimeUpdate(),this._teardownScrollFix()}_setupScrollFix(){this._scrollHandler=()=>{const t=window.scrollY||document.documentElement.scrollTop;t<=0&&(this._wasAtTop=!0),0===t&&this._wasAtTop&&(this._wasAtTop=!1,this._scheduleLayoutRecovery())},window.addEventListener("scroll",this._scrollHandler,{passive:!0});const t=t=>{1===t.touches.length&&(this._touchStartY=t.touches[0].clientY,this._touchActive=!0)},e=t=>{if(!this._touchActive)return;this._touchActive=!1;const e=t.changedTouches[0].clientY-this._touchStartY,i=window.scrollY||document.documentElement.scrollTop;e>40&&i<=0&&this._scheduleLayoutRecovery(1500)};window.addEventListener("touchstart",t,{passive:!0}),window.addEventListener("touchend",e,{passive:!0}),this._teardownScrollFix=()=>{window.removeEventListener("scroll",this._scrollHandler),window.removeEventListener("touchstart",t),window.removeEventListener("touchend",e),this._recoveryTimer&&clearTimeout(this._recoveryTimer)}}_scheduleLayoutRecovery(t=500){this._recoveryTimer&&clearTimeout(this._recoveryTimer),this._recoveryTimer=setTimeout(()=>this._fixCardTransforms(),t),setTimeout(()=>this._fixCardTransforms(),t+300),setTimeout(()=>this._fixCardTransforms(),t+600)}_fixCardTransforms(){const t=this._findMasonryView();if(!t)return;const e=t.querySelectorAll("*"),i=[];for(const t of e){const e=t.style.transform;e&&e.includes("translate")&&i.push({el:t,transform:e})}if(0!==i.length){for(const{el:t}of i)t.style.transform="";t.offsetHeight,requestAnimationFrame(()=>{for(const{el:t,transform:e}of i)t.style.transform=e;requestAnimationFrame(()=>{t.offsetHeight,this._triggerResize()})})}else this._triggerResize()}_triggerResize(){window.dispatchEvent(new Event("resize")),this.offsetHeight,this.getBoundingClientRect(),this.requestUpdate()}_findMasonryView(){const t=["hui-masonry-view","hui-panel-view","hui-view","hui-sections-view"];for(const e of t){const t=document.querySelector(e);if(t)return t}const e=document.querySelector("home-assistant");if(e?.shadowRoot)for(const i of t){const t=e.shadowRoot.querySelector(i);if(t)return t}return null}_startDateTimeUpdate(){this._currentDateTime=new Date,this._dateTimeInterval=setInterval(()=>{this._currentDateTime=new Date},1e3)}_stopDateTimeUpdate(){this._dateTimeInterval&&(clearInterval(this._dateTimeInterval),this._dateTimeInterval=void 0)}_teardownScrollFix(){this._recoveryTimer&&clearTimeout(this._recoveryTimer)}render(){return this._config?q`
      <ha-card>
        ${this._renderHeader()}
        ${this._renderContent()}
        ${this._renderFooter()}
