...
`,gt="1.0.1",mt="hass-layout-card",vt={type:`custom:${mt}`,title:"Layout Card",subtitle:"",show_datetime:!0,datetime_format:"default",content:"<p>Welcome to your custom layout card!</p>"},yt={default:{date:{weekday:"long",year:"numeric",month:"long",day:"numeric"},time:{hour:"2-digit",minute:"2-digit"}},short:{date:{year:"numeric",month:"short",day:"numeric"},time:{hour:"2-digit",minute:"2-digit"}},iso:{date:{year:"numeric",month:"2-digit",day:"2-digit"},time:{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1}}};var bt;let At=class extends nt{static get styles(){return $t}setConfig(t){this._config={...vt,...t}}render(){if(!this._config)return B`<div class="editor-container">Loading...</div>`;const t=Object.keys(yt).map(t=>B`
